@php
    $images = $product->image_urls ?? [$product->thumbnail];
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4 mb-8" x-data="{ qty: 1 }">
                        ...
                        <button @click="$store.cart.addItem({{ Js::from(['id' => $product->id, 'name' => $product->name, 'price' => $product->price]) }}, qty); $store.toast.success('Added to cart')" class="flex-1 py-3 bg-market-600 hover:bg-market-700 text-white font-medium rounded-xl transition-colors flex items-center justify-center gap-2">
