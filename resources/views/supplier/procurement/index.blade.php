            ...
            <div class="flex gap-8">
                ...
                <div class="flex-1 min-w-0">
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Purchase orders generated from customer orders placed with your stock</p>
                    </div>
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                    @forelse($procurements as $procurement)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                                            <td class="px-5 py-4">
                                                <a href="{{ route('supplier.procurement.show', $procurement) }}" class="text-sm font-medium text-market-700 dark:text-market-300 hover:underline">{{ $procurement->po_number }}</a>
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{{ $procurement->created_at?->format('M d, Y') }}</p>
                                            </td>
                                            <td class="px-5 py-4">
                                                <p class="text-sm text-gray-900 dark:text-white">{{ $procurement->seller?->name ?? '—' }}</p>
                                            ...
                                            <td class="px-5 py-4 text-right">
                                                <a href="{{ route('supplier.procurement.show', $procurement) }}" class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors">
                                            ...
                                            <td colspan="7" class="px-5 py-12 text-center">
                                                <div class="flex flex-col items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Procurement orders are created automatically when customers buy sourced products.</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
