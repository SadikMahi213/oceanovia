<header class="sticky top-0 z-50 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-16 lg:h-20 gap-4">
                ...
                <form action="{{ route('products.search') }}" method="GET" class="relative">
                    <div class="flex items-center">
                        <div class="relative flex-1">
                            ...
                            >
                            <button type="submit" aria-label="Search" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-market-600 dark:hover:text-market-400 transition-colors">
            ...
            <div class="flex items-center gap-1 lg:gap-2">
                ...
                @auth
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-50 animate-slide-down" x-cloak>
                            ...
                            <a href="{{ Auth::user()->getDashboardRoute() }}" class="flex items-center gap-3 px-4 py-2 text-sm hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                ...
                {{-- Mobile menu toggle --}}
                <button @click="document.querySelector('.mobile-menu-panel').classList.toggle('hidden')" aria-label="Toggle menu" class="md:hidden p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors" x-data x-cloak>
    ...
    <div class="md:hidden px-4 pb-3">
        <form action="{{ route('products.search') }}" method="GET" class="relative">
            ...
            <button type="submit" aria-label="Search" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500">
