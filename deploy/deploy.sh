...
# Resend is the email provider. MAIL_* values are only used if MAIL_MAILER
# is ever overridden back to smtp; do not set SMTP/Gmail credentials.
...
MAIL_PASSWORD=$MAIL_PASSWORD
MAIL_ENCRYPTION=tls
MAIL_FROM_ADDRESS="noreply@contact.oceanovia.com"
