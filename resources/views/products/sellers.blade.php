        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <a href="{{ route('register', ['role'=>'seller']) }}" class="inline-flex items-center gap-2 px-6 py-3 bg-market-600 hover:bg-market-700 text-white font-medium rounded-xl transition-colors">
                        Become a Seller
                    </a>
                </div>
            @endif
