<x-guest-layout>
    ...
    @section('auth_subtitle', 'Join MulitVendor and start shopping or selling today')
    @section('auth_footer')
        <span>Already have an account? <a href="{{ route('login') }}" class="font-medium text-market-600 hover:text-market-700 dark:text-market-400 dark:hover:text-market-300 transition-colors">Sign in</a></span>
    @endsection
        ...
        <div>
            ...
            <div class="mt-2 grid grid-cols-3 gap-2">
                <label class="relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 has-[:checked]:border-market-500 has-[:checked]:bg-market-50 dark:has-[:checked]:bg-market-900/20 has-[:checked]:ring-2 has-[:checked]:ring-market-500/20 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600">
                    <input type="radio" name="role_type" value="customer" class="sr-only" {{ old('role_type') === 'customer' || !old('role_type') ? 'checked' : '' }} required>
                ...
                <label class="relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 has-[:checked]:border-market-500 has-[:checked]:bg-market-50 dark:has-[:checked]:bg-market-900/20 has-[:checked]:ring-2 has-[:checked]:ring-market-500/20 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600">
                    <input type="radio" name="role_type" value="seller" class="sr-only" {{ old('role_type') === 'seller' ? 'checked' : '' }} required>
                    <div class="w-full text-center">
                ...
                <label class="relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 has-[:checked]:border-market-500 has-[:checked]:bg-market-50 dark:has-[:checked]:bg-market-900/20 has-[:checked]:ring-2 has-[:checked]:ring-market-500/20 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600">
                    <input type="radio" name="role_type" value="supplier" class="sr-only" {{ old('role_type') === 'supplier' ? 'checked' : '' }} required>
                    <div class="w-full text-center">
