        ...
        <header class="w-full border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <button @click="$store.app.toggleDarkMode()" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
                    ...
                    <a href="{{ route('home') }}" class="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
